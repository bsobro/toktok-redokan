...
class rehub_conditional_widget extends WP_Widget {
    ...
    function __construct() {
        ...
        parent::__construct('rehub_conditional_widget', __('ReHub: Show only in singular pages', 'rehub_framework'), $widget_ops, $control_ops  );
    }
...
function widget( $args, $instance ) {
	...
	function form( $instance ) {
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'reviewonly' ); ?>"><?php _e('Enable only in posts with review?', 'rehub_framework'); ?></label>
