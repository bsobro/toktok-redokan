...
function widget( $args, $instance ) {
	...
	?>
	    ...
	    <?php if ($post_type == 'post') :?>
	    	<?php rehub_top_offers_widget_block_post($tags, $number, $order, $random, $orderby, $notexpired);?>
	...
	function update( $new_instance, $old_instance ) {
		...
		$instance['notexpired'] =  $new_instance['notexpired'];
	...
	function form( $instance ) {
		...
		$defaults = array( 'title' => __('Top offers', 'rehub_framework'), 'number' => 5, 'tag' => '', 'post_type' => 'post', 'order' => '', 'tags' =>'', 'random' =>'', 'orderby'=> 'DESC', 'notexpired'=> '');
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'notexpired' ); ?>"><?php _e('Exclude expired?', 'rehub_framework'); ?></label>
