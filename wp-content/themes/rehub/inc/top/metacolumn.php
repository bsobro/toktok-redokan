    ...
    <div class="rehub_meta_fields">                                 
    	...
    	<?php if($field_type =='checkbox') : ?>
            <div class="rehub_meta_field rehub_field_<?php echo $count; ?>">
                <?php if ($metavalue['column_meta_icon']) : ?>
                    <?php $field_value_check = ($field_value =='1' || $field_value =='on') ? '<i class="far '.$metavalue["column_meta_icon"].'"></i>' : '' ?>
            	<?php else :?>
                    <?php $field_value_check = ($field_value =='1' || $field_value =='on') ? '<i class="far fa-check"></i>' : '<i class="far fa-times"></i>' ?>
                <?php endif; ?>
    	...
    	<?php else : ?>
            ...
            <div class="rehub_meta_field rehub_field_<?php echo $count; ?><?php echo $field_value_exist ; ?>">
                <span class="rehub_meta_field_title"><?php if ($metavalue['column_meta_icon']) : ?><span class="rehub_meta_field_icon"<?php echo $icon_font_style; ?>><i class="far <?php echo $metavalue['column_meta_icon']; ?>"></i></span> <?php endif ;?><?php if ($metavalue['column_meta_label']) : ?><span class="rehub_meta_field_label"<?php echo $label_font_style; ?>><?php echo esc_html ($metavalue['column_meta_label']); ?></span><?php endif ;?></span>
