		...
		<div id="re-compare-bar" class="from-right">
			<div id="re-compare-bar-wrap">
				<div id="re-compare-bar-heading">
					<h5 class="rehub-main-color"><?php _e('Compare items', 'rehub_framework');?><i class="fal fa-times-circle closecomparepanel floatright" aria-hidden="true"></i></h5>
				</div>
				<div id="re-compare-bar-tabs">
					...
					<?php endif; ?>
					<span class="re-compare-destin wpsm-button rehub_main_btn" data-compareurl=""><?php _e('Compare', 'rehub_framework');?><i class="far fa-arrow-circle-right" aria-hidden="true"></i></span>
				</div>
			</div>
		</div>
...
if (!function_exists('re_compare_item_in_panel')) {
	function re_compare_item_in_panel($compareid) {	
		...
		$out = '<div class="re-compare-item compare-item-'.$compareid.'" data-compareid="'.$compareid.'">';	
			$out .= '<i class="fas fa-times-circle re-compare-new-close"></i>';
            ...
            if ( '' != $the_price && function_exists('wc_price') ) {
                $out .= '<div class="greencolor font80">'.strip_tags( wc_price( $the_price ) ).'</div>';
            }                							
		$out .= '</div>';
