	    	...
	    	<div class="rh-cartbox widget">
	            <div>
	                ...
	                <div class="profile-stats">
	                    <div><i class="far fa-user-circle"></i> <?php _e( 'Registration', 'rehub_framework' );  echo ': ' . mb_substr( $vendor->user_registered, 0, 10 ); ?></div>
						...
						<div class="profile-description">
							<div>
								...
								<p>
									...
									<?php if ($phone):?>
										<br />
										<a href="tel:<?php echo $phone; ?>"><i class="fas fa-mobile-android-alt"></i> <?php echo $phone; ?></a>
									<?php endif;?>
									<?php if ($company_url):?>
										<br />
										<a href="<?php echo esc_url($company_url); ?>"><i class="far fa-globe"></i> <?php echo $company_url; ?></a>
									<?php endif;?>									
								</p>
							</div>
						</div>
						<?php if ($social_icons):?>
			                <div class="profile-socbutton">
			                    <div class="social_icon small_i">
				                    <?php if ( $facebook_url != '') { ?><a href="<?php echo $facebook_url; ?>" target="_blank" class="author-social fb" rel="nofollow"><i class="fab fa-facebook"></i></a><?php } ?>
				                    <?php if ( $instagram_username != '') { ?><a href="//instagram.com/<?php echo $instagram_username; ?>" target="_blank" class="author-social fb" rel="nofollow"><i class="fab fa-instagram"></i></a><?php } ?>
				                    <?php if ( $twitter_username != '') { ?><a href="//twitter.com/<?php echo $twitter_username; ?>" target="_blank" class="author-social tw" rel="nofollow"><i class="fab fa-twitter"></i></a><?php } ?>
				                    <?php if ( $googleplus_url != '') { ?><a href="<?php echo $googleplus_url; ?>" target="_blank" class="author-social gp" rel="nofollow"><i class="fab fa-google-plus"></i></a><?php } ?>
				                    <?php if ( $pinterest_url != '') { ?><a href="<?php echo $pinterest_url; ?>" target="_blank" class="author-social gp" rel="nofollow"><i class="fab fa-pinterest"></i></a><?php } ?>
				                    <?php if ( $youtube_url != '') { ?><a href="<?php echo $youtube_url; ?>" target="_blank" class="author-social yt" rel="nofollow"><i class="fab fa-youtube"></i></a><?php } ?>
				                    <?php if ( $linkedin_url != '') { ?><a href="<?php echo $linkedin_url; ?>" target="_blank" class="author-social fb" rel="nofollow"><i class="fab fa-linkedin"></i></a><?php } ?>
			                     </div>
			                </div>
		           		<?php endif;?>
		           	<?php else:?>
						<div class="profile-description">
							<div>
								...
								<p>
									...
									<?php if ($wcfreephone):?>
										<br />
										<a href="tel:<?php echo $wcfreephone; ?>"><i class="fas fa-mobile-android-alt"></i> <?php echo $wcfreephone; ?></a>
									<?php endif;?>
								</p>
							</div>
						</div>		           		
