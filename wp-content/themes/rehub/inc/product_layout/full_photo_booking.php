                            ...
                            <div class="rh-336-content-area tabletblockdisplay disablefloattablet floatleft mb20">
                                ...
                                <div class="woo-title-area mb10 flowhidden">
                                    <div class="rh-cat-list-title woo-cat-string-block">
                                        ...
                                        if ( ! empty( $categories ) ) {
                                            foreach( $categories as $category ) {
                                                $output .= '<a class="rh-cat-label-title rh-cat-'.$category->term_id.'" href="' . esc_url(  get_term_link( $category->term_id, 'product_cat' ) ) . '" title="' . esc_attr( sprintf( __( 'View all posts in %s', 'rehub_framework' ), $category->name ) ) . '">' . esc_html( $category->name ) . '</a>' . $separator;
                                            }
                                    ...
                                    <div>
                                        ...
                                        <h1 class="product_title entry-title <?php if(rehub_option('wishlist_disable') !='1') :?><?php echo getHotIconclass($post->ID, true); ?><?php endif ;?>">
                    ...
                    if (rh_is_plugin_active('content-egg/content-egg.php')){
                        ...
                        if(!empty($youtubecontent)){
                            $tabs['woo-ce-videos'] = array(
                                'title' => __('Video Reviews', 'rehub_framework'),
                                'priority' => '21',
