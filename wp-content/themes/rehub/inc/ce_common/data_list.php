                    ...
                    <div class="offer_thumb">   
                        ...
                        <?php if (!empty($item['extra']['itemLinks'][3])): ?>
                            <span class="add_wishlist_ce">
                                <a href="<?php echo $item['extra']['itemLinks'][3]['URL'];?>" rel="nofollow" target="_blank" ><i class="far fa-heart"></i></a>
                            </span>
                        <?php endif; ?>                                              
                    </div>
                    <div class="desc_col">
                        ...
                        <?php if (!empty($item['extra']['offers'])): ?>
                            ...
                            <?php foreach ($offers_flipkart as $offer_flipkart):?>
                                <div class="font80 flipkart_offers_extra lineheight15">
                                    <i class="far fa-check-circle greencolor" aria-hidden="true"></i> <span><?php echo $offer_flipkart;?></span>
                                </div>
                            <?php endforeach ;?>
                        <?php endif; ?>                                                                     
