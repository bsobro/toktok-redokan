...
<?php endif; ?>	
<?php if (is_singular('post') && rehub_option('rehub_replace_color') =='1') :?>
...
<?php endif; ?>	
<?php if (rehub_option('rehub_nav_font_custom') =='1') :?>
...
.woocommerce .widget_price_filter .ui-slider .ui-slider-range{ background: <?php echo $maincolor;?>;}
@media (max-width: 767px) {
	.postNavigation a{ background: <?php echo $maincolor; ?>; }
}
.rh-main-bg-hover:hover{color: #fff !important}
...
.widget_layered_nav ul li.chosen a:before{ color: <?php echo $maincolor; ?>; }
...
input#ywqa-send-answer{ background: <?php echo $seccolor ?> !important; color: #fff !important;}
.widget.widget_affegg_widget .title:after, .widget.top_offers .title:after, .vc_tta-tabs.wpsm-tabs .vc_tta-tab.vc_active, .vc_tta-tabs.wpsm-tabs .vc_tta-panel.vc_active .vc_tta-panel-heading, .widget.cegg_widget_products .title:after{border-top-color: <?php echo $seccolor ?> !important;}  
...
<?php if(rehub_option('rehub_btnoffer_color_hover') !='') : ?>
	...
	.rehub_offer_coupon:hover i.far, .rehub_offer_coupon:hover i.fal, .rehub_offer_coupon:hover i.fas{ color: <?php echo rehub_option('rehub_btnoffer_color_hover') ?>}
...
<?php elseif(rehub_option('width_layout') =='extended') : ?>
	...
	@media (min-width:1400px){ 
		...
		.sidebar, .side-twocol, .vc_row.vc_rehub_container > .vc_col-sm-4{ width: 270px} 
		.vc_row.vc_rehub_container > .vc_col-sm-8, .main-side:not(.full_width), .main_slider.flexslider{width:1030px;} 
	}
	@media (min-width:1600px){ 
		...
		.sidebar, .side-twocol, .vc_row.vc_rehub_container > .vc_col-sm-4{ width: 270px} 
		.vc_row.vc_rehub_container > .vc_col-sm-8, .main-side:not(.full_width), .main_slider.flexslider{width:1230px;} 
	}
<?php endif; ?>	
