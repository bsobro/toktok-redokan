...
<!-- /Logo section -->  
<!-- Main Navigation -->
<div class="search-form-inheader main-nav<?php if (rehub_option('rehub_logo_inmenu') !='') {echo ' mob-logo-enabled';}?><?php if (rehub_option('rehub_sticky_nav') !=''){echo ' rh-stickme';}?><?php echo $header_menuline_style;?>">  
