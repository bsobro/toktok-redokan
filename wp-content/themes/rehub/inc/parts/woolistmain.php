	...
	<div class="newscom_wrap_table">		
        ...
        <div class="newscom_detail">
        	...
        	<div class="newscom_head">
    		    <?php echo rh_expired_or_not($post->ID, 'span');?><h2 class="<?php echo getHotIconclass($post->ID, true); ?>"><a href="<?php the_permalink();?>"><?php the_title();?></a></h2>
            ...
            <div class="clearfix floatleft"><?php wc_get_template( 'loop/rating.php' );?></div> 
