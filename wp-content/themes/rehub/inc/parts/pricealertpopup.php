...
<?php if(rh_is_plugin_active('content-egg/content-egg.php')):?>
    <?php if (ContentEgg\application\helpers\TemplateHelper::isPriceAlertAllowed($unique_id, $module_id)): ?>
        ...
        <div class="pricealertpopup-wrap flowhidden">
            <span class="csspopuptrigger floatright mb10 greencolor" data-popup="pricealert_<?php echo $rand;?>"><i class="far fa-bell mr5" aria-hidden="true"></i> <?php _e('Set Lowest Price Alert', 'rehub_framework');?></span>
            <div class="csspopup" id="pricealert_<?php echo $rand;?>">
                <div class="csspopupinner cegg-price-alert-popup">
                    <span class="cpopupclose">×</span>            
                    <div class="cegg-price-alert-wrap">                       
                        <div class="re_title_inmodal"><i class="far fa-bell" aria-hidden="true"></i> <?php _e('Notify me, when price drops', 'rehub_framework'); ?></div>
