...
<div class="border-grey woocommerce table_view_block <?php echo $reveal_enabled; echo $coupon_style; echo $deal_type; ?>">
    ...
    <div class="block_with_coupon <?php echo $deal_type;?>">
        ...
        <div class="desc_col">  
            ...
            <h3 class="<?php echo getHotIconclass($post->ID, true); ?>"><a href="<?php echo get_permalink(); ?>"><?php echo rh_expired_or_not($post->ID, 'span');?><?php $title = get_the_title(); echo wp_trim_words( $title, 10, '...' ) ?></a></h3>
