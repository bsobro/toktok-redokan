...
$price_meta = (isset($price_meta)) ? $price_meta : '1';
?>
...
<article class="col_item offer_grid mobile_compact_grid offer_grid_com<?php if ($disable_act != 1) :?> offer_act_enabled<?php endif;?><?php if ($disable_btn == 1) :?> no_btn_enabled<?php endif;?><?php echo rh_expired_or_not($post->ID, 'class');?>"> 
    <div class="info_in_dealgrid">
        ...
        <div class="grid_desc_and_btn">
            ...
            <?php if ($disable_btn != 1) :?>
                <div class="mt10 text-center"><?php rehub_create_btn('no', 'button') ;?></div>
            <?php endif;?>   
        </div>                                       
    </div>
    <div class="meta_for_grid">
        ...
        <div class="date_for_grid floatright">
            <span class="date_ago">
                <i class="far fa-clock"></i><?php printf( __( '%s ago', 'rehub_framework' ), human_time_diff( get_the_time( 'U' ), current_time( 'timestamp' ) ) ); ?>
            </span>        
        </div>   
    </div>
