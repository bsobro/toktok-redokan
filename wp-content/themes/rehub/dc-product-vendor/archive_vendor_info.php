			...
			<div class="pl20 pr20 tabledisplay <?php echo $adaptive_class; ?>">
	    		...
	    		<div id="wcvendor_profile_act_desc" class="wcvendor_profile_cell">
					...
					<div class="wcmvendor_store_phones font80 lineheight15">
						<?php if ($vendor_phone) : ?>
							<i class="fas fa-mobile-android-alt"></i> <?php echo $vendor_phone; ?><br />
						<?php endif; ?>
						<?php if ($vendor_email ) : ?>
							<i class="far fa-envelope"></i> <?php echo $vendor_email; ?><br />
						<?php endif; ?>
						<?php if ($external_store_url ) : ?>
							<i class="far fa-globe"></i> <?php echo $external_store_url; ?>
						<?php endif; ?>
					</div>
	    		</div>
	    		<div id="wcvendor_profile_act_btns" class="wcvendor_profile_cell">
					...
					<div class="profile-socbutton">
						<div class="social_icon small_i">
							<?php if ( $vendor_fb_profile != '') { ?><a href="<?php echo $vendor_fb_profile; ?>" target="_blank" class="author-social fb" rel="nofollow"><i class="fab fa-facebook"></i></a><?php } ?>
							<?php if ( $vendor_instagram != '') { ?><a href="//instagram.com/<?php echo $vendor_instagram; ?>" target="_blank" class="author-social fb" rel="nofollow"><i class="fab fa-instagram"></i></a><?php } ?>
							<?php if ( $vendor_twitter_profile != '') { ?><a href="//twitter.com/<?php echo $vendor_twitter_profile; ?>" target="_blank" class="author-social tw" rel="nofollow"><i class="fab fa-twitter"></i></a><?php } ?>
							<?php if ( $vendor_google_plus_profile != '') { ?><a href="<?php echo $vendor_google_plus_profile; ?>" target="_blank" class="author-social gp" rel="nofollow"><i class="fab fa-google-plus"></i></a><?php } ?>
							<?php if ( $vendor_youtube != '') { ?><a href="<?php echo $vendor_youtube; ?>" target="_blank" class="author-social yt" rel="nofollow"><i class="fab fa-youtube"></i></a><?php } ?>
							<?php if ( $vendor_linkdin_profile != '') { ?><a href="<?php echo $vendor_linkdin_profile; ?>" target="_blank" class="author-social fb" rel="nofollow"><i class="fab fa-linkedin"></i></a><?php } ?>
						 </div>
					</div>
					<?php endif; ?>
