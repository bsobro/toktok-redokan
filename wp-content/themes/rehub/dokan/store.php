			...
			<div class="rh-cartbox widget">
				<div>
					...
					<div class="profile-stats">
						<div><i class="far fa-user-circle"></i> <?php _e( 'Registration', 'rehub_framework' );  echo ': ' . mb_substr( $store_user->user_registered, 0, 10 ); ?></div>
					...
					<div class="profile-description">
						<div>
							...
							<?php if ( $store_user->user_url ):?>
								<br />
								<i class="far fa-globe"></i> <a href="<?php echo esc_url( $store_user->user_url ); ?>"><?php echo $store_user->user_url; ?></a>
							<?php endif;?>
						...
						<div class="social_icon small_i">
							<?php foreach( $social_fields as $key => $field ) { ?>
								<?php if ( isset( $store_info['social'][ $key ] ) && !empty( $store_info['social'][ $key ] ) ) { ?>
									  <a href="<?php echo esc_url( $store_info['social'][ $key ] ); ?>" class="author-social <?php echo esc_attr( $key ) ?>" title="<?php echo $field['title']; ?>" target="_blank"><i class="fab fa-<?php echo $field['icon']; ?>"></i></a>
								<?php } ?>
							<?php } ?>
						</div>
					</div>
