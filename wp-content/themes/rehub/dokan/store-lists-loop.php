...
if ( $sellers['users'] ) {
        ...
        foreach ( $sellers['users'] as $seller ) {
            ...
            <li class="col_item">
               <div class="member-inner-list">
					...
					<?php else : ?>
						<div class="mt10 mb10"><a class="dokan-btn dokan-btn-theme" href="<?php echo $store_url; ?>"><?php _e( 'Visit Store', 'rehub_framework' ); ?></a></div>
					<?php endif; ?>
                </div> 
            </li>
        <?php } ?>
    ...
    if ( $num_of_pages > 1 ) {
        ...
        $pagination_args = array(
            ...
            'type'      => 'array',
            'prev_text' => __( '&larr; Previous', 'rehub_framework' ),
            'next_text' => __( 'Next &rarr;', 'rehub_framework' ),
        );
