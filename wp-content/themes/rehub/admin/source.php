...
$custom_badge_admin = array(
	...
	'label' => __('Add badge', 'rehub_framework'),
	'description' => __('Check this if you want to show badge. You can customize them in theme option', 'rehub_framework'),
	'items' => array(
	    array(
	        'value' => '0',
...
function rehub_get_post_layout_array($type)
{
	$postlayout = apply_filters( 'rehub_post_layout_array', array(
		...
		array(
			'value' => 'meta_compact',
			'label' => __('Compact (Button Block Under Title)', 'rehub_framework'),
		),
		array(
			'value' => 'meta_compact_dir',
			'label' => __('Compact (Button Block Before Title)', 'rehub_framework'),
		),				
		array(
			'value' => 'corner_offer',
	...
	if (rh_is_plugin_active('content-egg/content-egg.php')){
		$postlayoutce = array(
			...
			array(
				...
				'label' => __('Auto Tabs Content Egg (deprecated)', 'rehub_framework'),
			),
			array(
