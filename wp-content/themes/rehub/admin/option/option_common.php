...
return array(
			...
			array(
				...
				'fields' => array(
					...
					array(
						'type' => 'textbox',
						'name' => 'rehub_telegram',
						'label' => __('Telegram link', 'rehub_framework'),
						'validation' => 'url',
					),
					array(
						'type' => 'textbox',
			...
			array(
				...
				'fields' => array(
					...
					array(
						...
						'label' => __('Disable wishlist', 'rehub_framework'),
						'default' => '0',
					),					
					array(
						'type' => 'select',
					...
					array(
						...
						'label' => __('Allow to use wishlist only for logged users', 'rehub_framework'),
						'default' => '0',
					),										
					array(
						'type' => 'toggle',
			...
			array(
				...
				'fields' => array(
					...
					array(
						...
						'description' => __('This is for seo purpose. Must be short name. Also, set correct logo width and height in theme option - logo option', 'rehub_framework'),						
					),			
					array(
						'type' => 'toggle',
			...
			array(
				...
				'fields' => array(
					...
					array(
						...
						'label' => __('Enable Affiliate Store taxonomy for posts', 'rehub_framework'),
			...
			array(
				...
				'fields' => array(
					...
					array(
						...
						'description' => __('Example: 1,2,3;Title;23, where 1,2,3 - category IDs, Title - a general name for category group, 23 - a page ID of comparison. You can add also custom taxonomy in the end. By default, categories will be used. Delimiter is ";"<br/><br/>Attention: for woocommerce category comparison, use next: 1,2,3;Title;23;product_cat', 'rehub_framework'),
						'dependency' => array(
			...
			array(
				...
				'fields' => array(	
					...
					array(
						'type' => 'toggle',
						'name' => 'woo_rhcompare',
						'label' => __('Enable dynamic comparison for woocommerce?', 'rehub_framework'),
						'description' => __('You can use [wpsm_woocharts] on page for comparison', 'rehub_framework'),
						'default' => '0',
					),										
					array(
						'type' => 'toggle',
	...
	array(
		...
		'controls' => array(				
			array(
				'type' => 'section',
				'title' => __('Genral settings', 'rehub_framework'),
				'fields' => array(
					array(
						'type' => 'notebox',
						'name' => 'rehub_favicon_note',
					...
					array(
						...
						'items' => array(
							...
							array(
							'value' => '5_col_side',
							'label' => __('As 5 columns + sidebar', 'rehub_framework'),
							),																					
						),
						'default' => '3_col',
						'description' => __('Use 5 columns only in Extended Width Layout (Theme option - General - Width Style) and 30 products in loop', 'rehub_framework'),		
					),	
					array(
						'type' => 'select',
						'name' => 'woo_design',
						...
						'items' => array(
							...
							array(
							'value' => 'gridtwo',
							'label' => __('Compact Grid', 'rehub_framework'),
							),								
							array(
							'value' => 'list',
			...
			array(
				'type' => 'section',
				'title' => __('Custom Code Areas', 'rehub_framework'),
				'fields' => array(
					array(
						'type' => 'textarea',
			...
			array(
				'type' => 'section',
				'title' => __('Enable/Disable', 'rehub_framework'),
				'fields' => array(
					array(
						'type' => 'toggle',
						'name' => 'disable_woo_scripts',
						'label' => __('Disable Woocommerce Cart scripts', 'rehub_framework'),
						'description' => __('This will disable All Cart scripts of woocommerce. Use this only when you use woocommerce for affiliate site without cart', 'rehub_framework'),
						'default' => '0',
					),					
					array(
						'type' => 'toggle',
			...
			array(
				'type' => 'section',
				'title' => __('Synchronizations', 'rehub_framework'),
				'fields' => array(
					array(
						'type' => 'toggle',
