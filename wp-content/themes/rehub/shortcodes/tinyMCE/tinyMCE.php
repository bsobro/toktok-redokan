				...
				<form action="/" method="get" accept-charset="utf-8">
					<ul class="form_table head">
						<li>
							...
							<option class="shortcode_option" value="customget"><?php _e('Get Custom field or attribute value', 'rehub_framework') ;?></option>	
							<option class="shortcode_option" value="taxarchive"><?php _e('Taxonomy/Brand/Attribute directory', 'rehub_framework') ;?></option>													
