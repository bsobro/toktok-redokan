            ...
            <?php while ($wp_query->have_posts()) : $wp_query->the_post();?>
                    ...
                    <div class="content_constructor">
                        <?php if ($catalog_tax !='' && $catalog_tax_show =='1') :?>
                            <div class="post-meta"><i class="far fa-tag"></i>&nbsp;  
                            ...
                            <div class="rehub_catalog_fields font90 lineheight15 mb20 flowhidden">                                 
                                ...
                                <?php if($field_value !='') : ?>              
                                    <div class="rehub_catalog_field rehub_field_<?php echo $count; ?>">
                                        <div class="rehub_catalog_field_title floatleft mr5"><?php if ($catalog_field['catalog_icon']) : ?><i class="far <?php echo $catalog_field['catalog_icon']; ?>"></i><?php endif ;?><?php if ($catalog_field['catalog_fields_title']) : ?><span><?php echo $catalog_field['catalog_fields_title']; ?></span><?php endif ;?></div>
