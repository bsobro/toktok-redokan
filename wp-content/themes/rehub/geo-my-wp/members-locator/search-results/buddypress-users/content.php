<?php
/**
 * Members locator "Buddypress" search results template file. 
 * 
 ...
 * Instead you can copy-paste this template ( the "Buddypress" folder contains this file and the "css" folder ) 
 ...
 * It will show in the "Search results" dropdown menu as "Custom: Buddypress".
 */
?>	
