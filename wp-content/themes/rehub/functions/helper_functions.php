...
{   
    ...
    if ($small =='row' || $small =='flat' ) {
        $output .='<span data-href="https://plus.google.com/share?url='.urlencode($link).'" class="gp share-link-image" data-service="googleplus"><i class="fab fa-google-plus"></i></span>';
    }
...
<?php if(!function_exists('ampforwp_custom_template')):?>.amp-rh-article-header{margin:0 16px;}<?php endif;?>    
...
add_filter("ampforwp_template_locate", "rhampforwp_update_template_folder");
function rhampforwp_update_template_folder($folderName){
    $folderName = "amp";
    return $folderName;
}
