...
function rehub_register_sidebars() {
	...
	register_sidebar(array(
		'id' => 'footerbottom',
		'name' => __('Bottom Full width Footer', 'rehub_framework'),
	...
	register_sidebar(array(
		'id' => 'rhcustomsidebar',
		'name' => __('Custom sidebar area', 'rehub_framework'),
		'before_widget' => '<div id="%1$s" class="widget %2$s">',
		'after_widget' => '</div>',
		'before_title' => '<div class="title">',
		'after_title' => '</div>',
	...
	register_sidebar(array(
		...
		'name' => __('Custom sidebar area 2', 'rehub_framework'),
		'before_widget' => '<div id="%1$s" class="widget %2$s">',
		'after_widget' => '</div>',
		'before_title' => '<div class="title">',
		'after_title' => '</div>',
	...
	if(rehub_option('enable_brand_taxonomy') == 1 || REHUB_NAME_ACTIVE_THEME == 'RECASH'){
		register_sidebar(array(
			...
			'name' => __('Affiliate store archive sidebar', 'rehub_framework'),
			'before_widget' => '<div id="%1$s" class="widget %2$s">',
			'after_widget' => '</div>',
			'before_title' => '<div class="title">',
			'after_title' => '</div>',
...
function rehub_top_offers_widget_block_post($tags = '', $number = '5', $order = '', $random = '', $orderby='', $notexpired = '') { ?>
