...
$element = 'wpb_tabs';
$tabs_rehub = $style_tab = '';
if ( 'vc_tour' == $this->shortcode ) $element = 'wpb_tour';
if ( $element == 'wpb_tabs' ) $tabs_rehub = ' wpsm-tabs';
if ( $style_sec != '' ) $style_tab = ' n_b_tab';
...
$output .= "\n\t" . '<div class="' . $css_class . $tabs_rehub . $style_tab . '" data-interval="' . $interval . '">';
