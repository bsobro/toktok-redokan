...
function rhwoostore_tax_fields() {  
    ...
    add_action( 'product_cat_edit_form_fields', 'rhwoostore_tax_fields_edit', 10, 2 );  
    add_action( 'product_cat_add_form_fields', 'rhwoostore_tax_fields_new');
    add_action( 'edited_product_cat', 'rhwoostore_tax_fields_save', 10, 2 ); 
    add_action( 'create_product_cat', 'rhwoostore_tax_fields_save', 10, 2 );         
}
}
