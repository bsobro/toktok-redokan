...
function getCommentLike_re( $comment_text  ) {
	...
	$output .= '<span class="us-rev-vote-up'.$already.'" data-post_id="'.$post_id.'" data-informer="'.$comm_plus_count.'"><i class="far fa-thumbs-up"></i> <span class="comm_help_title">'.__('Helpful', 'rehub_framework').'</span>(<span class="help_up_count" id="commhelpplus'.$post_id.'">'.$comm_plus_count.'</span>)</span>'; 
	$output .= '<span class="us-rev-vote-down'.$already.'" data-post_id="'.$post_id.'" data-informer="'.$comm_minus_count.'"><i class="far fa-thumbs-down"></i> <span class="comm_help_title">'.__('Unhelpful', 'rehub_framework').'</span>(<span class="help_up_count" id="commhelpminus'.$post_id.'">'.$comm_minus_count.'</span>)</span>'; 
