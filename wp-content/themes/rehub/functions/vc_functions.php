    ...
    function rehub_woo_vc_filter_formodules() {
        return array(
            ...
            array(
                ...
                'heading' => __( 'Taxonomy slug', 'rehub_framework' ),
                'param_name' => 'tax_name',
                'description' => __( 'Enter slug of your taxonomy. Example, taxonomy for product brand - is <strong>store</strong>. For color attribute - <strong>pa_color</strong>, for product tags - <strong>product_tag</strong>', 'rehub_framework' ),
            ), 
            array(
                'type' => 'textfield',
                'group' => __( 'Taxonomy', 'rehub_framework' ),
    ...
    function rehub_vc_aj_filter_btns_formodules() {
        ...
        array(
            ...
            'params' => array(
                ...
                array(
                    "type" => "checkbox",      
                    "heading" => __('Use filter taxonomy within general taxonomy option', 'rehub_framework'),
                    "value" => array(__("Yes", "rehub_framework") => true ),
...
vc_add_params("compactgrid_loop_mod", array( 
    ...
    array(
        "type" => "dropdown",
        "class" => "",
        "heading" => __('Show Price meta as', 'rehub_framework'),
        "param_name" => "price_meta",
        "group" => __('Control', 'rehub_framework'),        
        "value" => array(
            __('User logo + Price', 'rehub_framework') => "1",
            __('Brand logo + Price', 'rehub_framework') => "2",
            __('Only Price', 'rehub_framework') => "3",  
            __('Nothing', 'rehub_framework') => "4",                                          
        ),
    ),         
    array(
        "type" => "dropdown",
...
vc_map( array(
    "name" => __('Simple list', 'rehub_framework'),
...
vc_add_params("wpsm_recent_posts_list", array(
    ...
    array(
        ...
        "class" => "",
        "group" => __('Control', 'rehub_framework'), 
        "heading" => __("Add border to list items", "rehub_framework"),
        "value" => array(__("Yes", "rehub_framework") => true ),
        "param_name" => "border",
    ), 
    array(
        "type" => "dropdown",
        "class" => "",
        "heading" => __('Show as columns', 'rehub_framework'),
        "group" =>  __('Control', 'rehub_framework'),
        "param_name" => "columns",
        "admin_label" => true,
        "value" => array(
    ...
    array(
        "type" => "textfield",
        "class" => "",
        "heading" => __("Search by Title", "rehub_framework"),
        "param_name" => "searchtitle",
        'description' => __('Set name CURRENTPAGE to show posts with similar title to current page', 'rehub_framework'),         
    ),                  
));
...
vc_add_params("wpsm_woogrid", array( 
    ...
    array(
        "type" => "dropdown",
        "class" => "",
        "heading" => __('Style of design', 'rehub_framework'),
        "param_name" => "gridtype",
        "group"  => __('Control', 'rehub_framework'),        
        "value" => array(
            __('Regular', 'rehub_framework') => "regular",                
            __('Compact', 'rehub_framework') => "compact",                              
        ), 
    ),      
    array(
        "type" => "dropdown",
...
vc_map( array(
    ...
    'params' => array(
        ...
        array(
            'type' => 'textfield',
            "group" =>  __('First Column', 'rehub_framework'),            
            'heading' => __('Place text', 'rehub_framework'),
