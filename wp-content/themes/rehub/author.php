...
$userpostslabel = __( 'User Posts', 'rehub_framework' );
$userdealslabel = __( 'User Deals', 'rehub_framework' );
        ...
        <aside class="sidebar authorsidebar">
            <div class="author_widget clearfix">
                ...
                <div class="profile-stats">
                    <div><i class="far fa-user"></i> <?php _e( 'Registration', 'rehub_framework' );  echo ': ' . mb_substr( $curauth->user_registered, 0, 10 ); ?></div>
                    <div><i class="far fa-comment"></i><?php _e( 'Comments', 'rehub_framework' ); echo ': ' . $count_comments; ?></div>
                    <div><i class="fas fa-heartbeat"></i><?php _e( 'Votes', 'rehub_framework' ); echo ': ' . $count_likes; ?></div>
                    <div><i class="far fa-briefcase"></i><?php _e( 'Total submitted', 'rehub_framework' ); echo ': ' . $totalsubmitted; ?></div>
                    <?php if (!empty($mycredpoint)) :?><div class="rh_mycred_point_bal"><i class="far fa-bar-chart"></i><?php echo $mycredlabel;?>: <?php echo $mycredpoint;?></div><?php endif;?>                               
                </div>
                <div class="profile-socbutton">
                    <div class="social_icon small_i">
                        <?php if(!empty($curauth->user_url)) : ?><a href="<?php echo $curauth->user_url ?>" class="author-social hm" rel="nofollow"><i class="far fa-home"></i></a><?php endif; ?>
                ...
                <div class="profile-usermenu mt20">
                    <ul class="user-menu-tab" role="tablist">
                        <li role="presentation" class="active">
                            <a href="#user-posts" aria-controls="user-posts" role="tab" data-toggle="tab" aria-expanded="true"><i class="far fa-edit"></i><?php echo $userpostslabel ?></a>
                        </li>
                    <?php if ( class_exists( 'Woocommerce' ) ) : ?> 
                        <li role="presentation">
                            <a href="#user-deals" aria-controls="user-deals" role="tab" data-toggle="tab" aria-expanded="true"><i class="far fa-tags"></i><?php echo $userdealslabel ?></a>
                        </li>
                    <?php endif; ?> 
                        <li role="presentation">
                            <a href="#user-comments" aria-controls="user-comments" role="tab" data-toggle="tab" aria-expanded="false"><i class="far fa-comment"></i><?php _e( 'Comments', 'rehub_framework' ); ?></a>
                        </li>
                    <?php if ( function_exists('bp_core_get_user_domain') ) : ?>
                        <li>
                            <a href="<?php echo bp_core_get_user_domain( $author_ID ); ?>"><i class="far fa-folder-open"></i><?php _e( 'Show full profile', 'rehub_framework' ); ?></a>
                        </li>
                    <?php endif; ?>
                    </ul>
                </div>
