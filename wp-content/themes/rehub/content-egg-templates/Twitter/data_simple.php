    ...
    <?php foreach ($items as $item): ?>
        <div class="twi_profile">
            ...
            <?php if ($item['extra']['followersCount']) :?>
                <a rel="nofollow" target="_blank" href="<?php echo $item['url']; ?>" class="twi-follow-btn" title="<?php echo esc_html($item['extra']['followersCount']); ?>"><i class="fab fa-twitter"></i> <?php _e('Follow', 'rehub_framework') ;?></a>
            <?php endif;?>                        
        </div>
        <div class="media">
