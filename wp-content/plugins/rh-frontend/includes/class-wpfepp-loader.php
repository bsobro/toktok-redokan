...
/**
 * The WPFEPP Loader is a class that is responsible for coordinating all actions and filters used throughout the plugin.
 *
 * @since 1.0.0
 * @package WPFEPP
 */
class WPFEPP_Loader {
	...
	*/
	...
	/**
	* Registers the actions with WordPress and the respective objects and their methods.
	*
	...
	*/
	...
	/**
	* Registers the filters with WordPress and the respective objects and their methods.
	*
	* @param string $hook The name of the WordPress hook to which we're registering a callback.
	* @param object $component The object that contains the method to be called when the hook is fired.
	* @param string $callback The function that resides on the specified component.
