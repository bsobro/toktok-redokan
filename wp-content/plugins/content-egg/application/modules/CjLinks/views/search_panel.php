    <select class="col-md-4 input-sm" ng-model="query_params.<?php echo $module_id; ?>.promotion_type">
    ...
    <select class="col-md-4 input-sm" ng-model="query_params.<?php echo $module_id; ?>.link_type">
