            ...
            <div class="data_panel">
                ...
                <div clas="row">
                    ...
                    <div class="col-md-6 col-lg-6 text-right">
                        <a class='btn btn-default btn-sm' ng-click="addBlank('<?php echo $module_id; ?>', 'contentCoupon')"><i class="glyphicon glyphicon-plus"></i> <?php _e('Add coupon', 'content-egg'); ?></a>
            ...
            <div ng-init="activeResultTabs['<?php echo $module_id; ?>'] = true" ui-sortable="{ 'ui-floating': true }" ng-model="models.<?php echo $module_id; ?>.added" class="row">
                <div class="col-md-12 added_data" ng-repeat="data in models.<?php echo $module_id; ?>.added">
                    <div class="row" style="padding: 5px;">
                        ...
                        <div ng-class="data.img ? 'col-md-9' : 'col-md-10'">
                            <div class="row" style="margin:0px;">
                                ...
                                <div class="col-md-4" style="padding:0px;">
                                    <input type="text" placeholder="<?php _e('Coupon code', 'content-egg'); ?>" ng-model="data.code" class="form-control" style="margin-bottom: 5px;">
                                </div>
                            </div>                            

                            <div class="row" style="margin:0px;">
                                <div class="col-md-8" style="padding:0px;">
                                    <input type="text" placeholder="<?php _e('Affiliate URL', 'content-egg'); ?> (<?php _e('required', 'content-egg'); ?>)" ng-model="data.url" class="form-control" style="margin-bottom: 5px;">
                                </div>
                                <div class="col-md-4" style="padding:0px;">
                                    <input type="text" placeholder="<?php _e('Merchant domain', 'content-egg'); ?>" ng-model="data.domain" class="form-control" style="margin-bottom: 5px;">
                                </div>
                            </div>                            

                            <input type="text" placeholder="<?php _e('Image\Logo URL', 'content-egg'); ?>" ng-model="data.img" class="form-control" style="margin-bottom: 5px;">
                            ...
                            <div class="row" style="margin:0px;">
                                <div class="col-md-6" style="padding:0px;">
                                    <div class="input-group" style="margin-bottom: 5px;">
                                        ...
                                        <input type="text" class="form-control" 
                                               placeholder="<?php _e('Start date (YYYY/MM/DD)', 'content-egg'); ?>"
                                ...
                                <div class="col-md-6" style="padding:0px;">
                                    <div class="input-group" style="margin-bottom: 5px;">
                                        <input type="text" class="form-control" 
                                               placeholder="<?php _e('End date (YYYY/MM/DD)', 'content-egg'); ?>"
                                               ...
                                               />
                                        <span class="input-group-btn">
                                            <button type="button" class="btn btn-default" ng-click="endDateOpened = true"><i class="glyphicon glyphicon-calendar"></i></butt                                            on>
                                        </span>    
                                    </div>
                                </div>                 
                        ...
                        <div class="col-md-2">
                            <span ng-if="data.url"><a href="{{data.url}}" target="_blank"><?php _e('Go to ', 'content-egg'); ?></a><br><br></span>
